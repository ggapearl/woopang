...
public class TrainStationManager : MonoBehaviour, IPlaceCacheProvider
{
    ...
    public void RefreshAnchors()
    {
        ...
        Debug.LogWarning($"[dbg][TrainStationManager][ANCHOR] RefreshAnchors Full={full} Indicator={indicator}");
        if (FileLogger.Instance != null && FileLogger.Instance.IsLogging)
            FileLogger.Instance.Log("ANCHOR", $"[Train] RefreshAnchors Full={full} Indicator={indicator}");
    }
}
